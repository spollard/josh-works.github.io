...
permalink: local-politics-self-loathing
---
...
I feel like throwing up a little. Maybe that's just because the flight I'm on is bouncing around a little, but I think it's partially guided by some healthy revulsion.
...
[The Ovarton Window]() is a notion that any possible political outcome is always one that is tolerable to all parties. Usually, the thing that is tolerable to both parties is also dispised by both, because "compromise" is never actually an effective solution, but it's the one that gets forced through via the vote, so that's what we get.
...
I'll give an example. Lets imagine there's a problem in a community with parking. The people that already live there like having free, accessible curb-side parking, while the people that _don't_ live there are perceived as a threat by moving into the neighborhood. (The residents will loose their easy parking.)

Here's a bunch of potential solutions to this parking problem:

- Ban any migration into the neighborhood
- Ban the construction of new dwelling units
- Ban the ownership of cars for any new residents
- Make registry of vehicles belonging to residents, and impound any vehicles found in neighborhood not on that registry
- Require any new construction to include two parking spaces per dwelling unit
- Require any new construction to include one parking space per unit
- No minimum parking spaces per unit requirement
- Install parking meters throughout neighborhoods so everyone pays for parking
- Institute parking permits for residents, non-residents found outside of certain hours get a ticket
- Charge _all_ vehicle owners monthly fee for parking in neighborhood
- Deed travel lane of roads over to the adjacent property owners, privatizing the roads

Which one of these do you think has any potential to get instituted?

Probably the one that seems least-bad to all parties (including local government), and I guarantee that the "least-bad" option isn't a long-term solution to the parking problem.

The winning solution is the one that can get forced through in the name of "compromise" and "please for the love of all that's good can we stop arguing about parking in every public meeting and I'll do anything to make you all stop complaining to me about this".

Politicians are rational, self-interested creatures. They're not better than anyone, they might be worse than most. Nothing that good will come from them.
...
Given the [growth of the Federal Register](), politicians are _exceptional_ at making new rules for people to follow.
...
Most of this "rule of law" thing we talk about in America is mostly the "rule of rules", and the rules themselves cannot be arrived at from [first principles](). If a "law" is really just a "rule", and the rule cannot be arrived at from first principles, in my mind, it's invalid and has no weight, and we'd all be better off as a society if we ignored it. (Looking at you, prohibition).

If I'm successful running for city council (and I might well be... sometimes people run without anyone contesting the seat, and the incumbent is stepping down from the council, so by virtue of showing up, I might get the seat)... one of the only ways I could tolerate my own presence on the council would be to consistently oppose the creation of new rules.

Which would earn me a functional failing grade as a politician, since they're mostly judged on making new rules.
...
(Keep in mind I'm young, white, married, educated. I'm part of the "desirable" class of people everyone could imagine moving into their neighborhood and having 2.4 kids. Oh, and I used to do sales, so I can usually talk my way into other people liking me. This is all cause for concern)

Zoning policy is the ideological brain-child of [redlining](), [institutional racism](), [xenophobia](), and [class/race-based prejudice]().

Most of the stuff we all hate about neighborhoods and poorly-built/designed public space isn't the result of the "free market", but is the result of even more government manipulation in the market. This chain of cause and effect goes all the way up to the Federal Reserve going to great lengths to make people buy houses they cannot afford. I love healthy, financially solvant communities, and "moar zoning" isn't the way to get there. [Read way more about zoning issues here]()

That is a *very* bold statement, but a quick romp through the records of when people talked openly about *why* zoning policy was being developed shows its true colors. (Incidentally, the reason government got into marriage licensing has a [similar background](), and look at how the original (racist) purpose of marriage policy was twisted into moralizing and hand-wringing.)
...
If this is the context I bring to any discussion about zoning, I cannot in good faith support a simple modification to the code.
...
> Should we ban Irish immigrants from living in this neighborhood, or should we ban them from living in our city all-together?
...
## Share the experience to the potential edification of others
...
## Try to dismantle bad things from the inside
